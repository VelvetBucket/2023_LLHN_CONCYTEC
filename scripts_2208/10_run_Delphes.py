...
for tev in tevs[:]:
    for type in types[:]:
        ...
        root = "/home/cristian/Desktop/HEP_Jones/paper_2208/scripts_2208"
        origin = root + f"/data/bins/{tev}/{type}/"
        destiny = root + f"/data/bins/{tev}/{type}/"
        ...
        for in_file in [f for f in sorted(glob.glob(origin + f'*.hepmc')) if 'pos' in f][:]:
            ...
            os.system('cd /home/cristian/Programs/MG5_aMC_v2_9_2/Delphes && ./DelphesHepMC '
                      f'cards/delphes_card_LLHNscanV4.tcl {out_file} {in_file}')
            #print(zbns)